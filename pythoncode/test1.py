...
dfA=pd.read_excel(r'C:\SLOTTING_TOOL\Export\ABC_8.xlsx')#slotting tool result
dfs= pd.read_excel (r'D:\OE\StockOnHand_2810.xlsx')#stock data
df7 = pd.read_csv (r'D:\OE\2810_June_Complete1.csv')#Outbound data
